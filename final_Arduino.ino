...
constexpr uint8_t wipeB = 5;     // Button pin for WipeMode
...
void setup() {
  ...
  digitalWrite(relay , LOW);    // Make sure door is lock
...
void granted ( uint16_t setDelay) {
  ...
  digitalWrite(relay, LOW);
   digitalWrite(sender,LOW);// Relock door
...
void denied() {
  ...
  digitalWrite(sender2,HIGH);
  delay(1500);
  digitalWrite(sender2,LOW);
...
void ShowReaderDetails() {
  ...
  if ((v == 0x00) || (v == 0xFF)) {
    ...
    // Visualize system is halted   // Turn on red LED
